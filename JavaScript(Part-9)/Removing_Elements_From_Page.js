...
//directly bhi hm remove kr skte h-add kr dete phele button remove krne se phele
//btn.remove();

p.remove();//pura para remove ho jaayega

body.remove();//puri body hi gayab ho jayaegi